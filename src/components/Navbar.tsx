      ...
      {mobileMenuOpen && (
        <div className="md:hidden bg-white py-4 px-4 border-b border-gray-200">
          <nav className="flex flex-col space-y-4 mb-6">
            <a href="#" className="text-gray-700 hover:text-indigo-600 transition-colors py-2">Features</a>
            <a href="#" className="text-gray-700 hover:text-indigo-600 transition-colors py-2">How It Works</a>
            <a href="#" className="text-gray-700 hover:text-indigo-600 transition-colors py-2">Resources</a>
